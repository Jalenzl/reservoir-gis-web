    ...
    kriging.plot = function(canvas, grid, xlim, ylim, colors) {
        ...
        for(i=0;i<n;i++)
            for(j=0;j<m;j++) {
                ...
                if (val >= 26000) {
                    index = 53
                } else if (val > 25686 && val <= 26000) {
                    index = 52
                } else if (val > 25372 && val <= 25686) {
                    index = 51
                } else if (val > 25058 && val <= 25372) {
                    index = 50
                } else if (val > 24744 && val <= 25058) {
                    index = 49
                } else if (val > 24430 && val <= 24744) {
                    index = 48
                } else if (val > 24116 && val <= 24430) {
                    index = 47
                } else if (val > 23802 && val <= 24116) {
                    index = 46
                } else if (val > 23488 && val <= 23802) {
                    index = 45
                } else if (val > 23174 && val <= 23488) {
                    index = 44
                } else if (val > 22860 && val <= 23174) {
                    index = 43
                } else if (val > 22546 && val <= 22860) {
                    index = 42
                } else if (val > 22232 && val <= 22546) {
                    index = 41
                } else if (val > 21918 && val <= 22232) {
                    index = 40
                } else if (val > 21604 && val <= 21918) {
                    index = 39
                } else if (val > 21290 && val <= 21604) {
                    index = 38
                } else if (val > 20976 && val <= 21290) {
                    index = 37
                } else if (val > 20662 && val <= 20976) {
                    index = 36
                } else if (val > 20348 && val <= 20662) {
                    index = 35
                } else if (val > 20034 && val <= 20348) {
                    index = 34
                } else if (val > 19720 && val <= 20034) {
                    index = 33
                } else if (val > 19406 && val <= 19720) {
                    index = 32
                } else if (val > 19092 && val <= 19406) {
                    index = 31
                } else if (val > 18778 && val <= 19092) {
                    index = 30
                } else if (val > 18464 && val <= 18778) {
                    index = 29
                } else if (val > 18150 && val <= 18464) {
                    index = 28
                } else if (val > 17836 && val <= 18150) {
                    index = 27
                } else if (val > 17522 && val <= 17836) {
                    index = 26
                } else if (val > 17208 && val <= 17522) {
                    index = 25
                } else if (val > 16894 && val <= 17208) {
                    index = 24
                } else if (val > 16580 && val <= 16894) {
                    index = 23
                } else if (val > 16266 && val <= 16580) {
                    index = 22
                } else if (val > 15952 && val <= 16266) {
                    index = 21
                } else if (val > 15638 && val <= 15952) {
                    index = 20
                } else if (val > 15324 && val <= 15638) {
                    index = 19
                } else if (val > 15010 && val <= 15324) {
                    index = 18
                } else if (val > 14696 && val <= 15010) {
                    index = 17
                } else if (val > 14382 && val <= 14696) {
                    index = 16
                } else if (val > 14068 && val <= 14382) {
                    index = 15
                } else if (val > 13754 && val <= 14068) {
                    index = 14
                } else if (val > 13440 && val <= 13754) {
                    index = 13
                } else if (val > 13126 && val <= 13440) {
                    index = 12
                } else if (val > 12812 && val <= 13126) {
                    index = 11
                } else if (val > 12498 && val <= 12812) {
                    index = 10
                } else if (val > 12184 && val <= 12498) {
                    index = 9
                } else if (val > 11870 && val <= 12184) {
                    index = 8
                } else if (val > 11556 && val <= 11870) {
                    index = 7
                } else if (val > 11242 && val <= 11556) {
                    index = 6
                } else if (val > 10928 && val <= 11242) {
                    index = 5
                } else if (val > 10614 && val <= 10928) {
                    index = 4
                } else if (val > 10300 && val <= 10614) {
                    index = 3
                } else if (val > 9972 && val <= 10300) {
                    index = 2
                } else if (val > 9644 && val <= 9972) {
                    index = 1
                } else if (val <= 9644) {
                    index = 0
                }
