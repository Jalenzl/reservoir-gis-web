...
// layer1
  ...
  const krigingFieldMap_l7: KrigingFieldMap = new KrigingFieldMap(
      viewer,
      krigingCanvas.value as HTMLCanvasElement,
      gridBoundaryLine,
      pressure_l7t1_jsonData,
      "boundary_line_01",
      "pressure"
  );
  ...
  await startKrigingInterpolation(krigingFieldMap_l7, pressure_l7t1_jsonData, sampleData_l7)
