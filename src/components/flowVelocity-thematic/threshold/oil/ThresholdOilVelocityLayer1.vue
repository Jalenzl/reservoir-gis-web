<template>
  <div class="cesiumContainer-threshold-oil1" id="cesiumContainer-threshold-oil1">
...
onMounted(async () => {
  /*--------initializing map------------*/
  let {viewer, scene, globe, clock} = CesiumTool.initMap("cesiumContainer-threshold-oil1")
...
.cesiumContainer-threshold-oil1 {
  position: relative;
  width: 100%;
  height: 99%;
