<template>
  <div class="cesiumContainer-threshold-oil6" id="cesiumContainer-threshold-oil6">
...
onMounted(async () => {
  /*--------initializing map------------*/
  let {viewer, scene, globe, clock} = CesiumTool.initMap("cesiumContainer-threshold-oil6")
...
.cesiumContainer-threshold-oil6 {
  position: relative;
  width: 100%;
  height: 99%;
